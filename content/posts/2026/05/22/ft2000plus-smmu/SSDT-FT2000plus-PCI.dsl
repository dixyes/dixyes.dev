DefinitionBlock ("", "SSDT", 2, "ARMLTD", "PHYTIUM ", 0x20260519)
{
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            {
                Package (0x04) { 0xFFFF, Zero,   Zero, 0x53 }, // INTA -> GSI 83
                Package (0x04) { 0xFFFF, One,    Zero, 0x54 }, // INTB -> GSI 84
                Package (0x04) { 0xFFFF, 0x02,   Zero, 0x55 }, // INTC -> GSI 85
                Package (0x04) { 0xFFFF, 0x03,   Zero, 0x56 },  // INTD -> GSI 86
                Package (0x04) { 0x1FFFF, Zero,   Zero, 0x53 }, // INTA -> GSI 83
                Package (0x04) { 0x1FFFF, One,    Zero, 0x54 }, // INTB -> GSI 84
                Package (0x04) { 0x1FFFF, 0x02,   Zero, 0x55 }, // INTC -> GSI 85
                Package (0x04) { 0x1FFFF, 0x03,   Zero, 0x56 },  // INTD -> GSI 86
                Package (0x04) { 0x2FFFF, Zero,   Zero, 0x53 }, // INTA -> GSI 83
                Package (0x04) { 0x2FFFF, One,    Zero, 0x54 }, // INTB -> GSI 84
                Package (0x04) { 0x2FFFF, 0x02,   Zero, 0x55 }, // INTC -> GSI 85
                Package (0x04) { 0x2FFFF, 0x03,   Zero, 0x56 }  // INTD -> GSI 86
            })
